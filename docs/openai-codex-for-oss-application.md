...
Source repository: `pjmin19/ansimtalk-`
...
Final packet: `docs/CODEX_FOR_OSS_SUBMISSION_PACKET.md`
...
- Educator boundary: `docs/EDUCATOR_GUIDE.md`, `docs/HUMAN_REVIEW_WORKFLOW.md`
- Safe sample output: `examples/reports/human_review_sample.md`
- Final submission packet: `docs/CODEX_FOR_OSS_SUBMISSION_PACKET.md`

## Submission Boundary

This file is ready for owner review and official form entry. The official form
requires account-specific fields such as the OpenAI Organization ID. Do not
claim submission, acceptance, Human-Verified status, or customer-ready status
until that live action and any response are separately recorded.
